...
import nuke
import goosebumps2_delivery
import ConfigParser
import sys
from goosebumps2_utilities import *
...
try:
    ...
    if sys.platform == "win32":
        g_delivery_folder = config.get('goosebumps2', 'delivery_folder_win32')
    else:
        g_delivery_folder = config.get('goosebumps2', 'delivery_folder')
